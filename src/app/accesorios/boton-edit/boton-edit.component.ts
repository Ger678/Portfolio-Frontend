...
export class BotonEditComponent implements OnInit {
  ...
  constructor(private btnService: BotonesService, private router: Router) {}
  ...
  onEditar(): void {
    console.log(
      'editar a esta id: ' + this.id + ' con este nombre: ' + this.name
    );
  ...
  onShare() {
    ...
    if (navigator.share) {
      navigator
        ...
        .then(() => console.log(this.shareObject))
